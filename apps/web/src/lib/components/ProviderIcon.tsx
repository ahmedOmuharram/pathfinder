...
function AnthropicLogo({ size, className }: { size: number; className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M17.304 3.541h-3.672l6.696 16.918H24zm-10.608 0L0 20.459h3.744l1.37-3.553h7.005l1.369 3.553h3.744L10.536 3.541zm-.371 10.223 2.291-5.946 2.291 5.946z" />
    </svg>
  );
}
...
function GoogleLogo({ size, className }: { size: number; className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 0a12.2 12.2 0 0 0 4.935 7.065A12.2 12.2 0 0 0 24 12a12.2 12.2 0 0 0-7.065 4.935A12.2 12.2 0 0 0 12 24a12.2 12.2 0 0 0-4.935-7.065A12.2 12.2 0 0 0 0 12a12.2 12.2 0 0 0 7.065-4.935A12.2 12.2 0 0 0 12 0z" />
    </svg>
  );
}

function OllamaLogo({ size, className }: { size: number; className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
