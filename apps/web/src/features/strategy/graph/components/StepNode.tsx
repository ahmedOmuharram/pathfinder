      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center gap-1">
        ...
        {isZeroResults && !validationError && (
          <div className="group relative -mt-1 flex items-center gap-1 text-xs font-semibold text-amber-700">
            ...
            <span>0 results</span>
            <div className="pointer-events-none absolute left-1/2 top-full z-50 mt-1 w-56 -translate-x-1/2 rounded-md border border-amber-200 bg-card px-2 py-2 text-xs font-medium text-amber-800 opacity-0 shadow-sm transition group-hover:opacity-100">
        ...
        {validationError && (
          <div className="mt-1 text-center text-xs font-semibold text-destructive">
            ...
            <button
              ...
              className="ml-1 text-xs font-semibold text-destructive underline decoration-destructive/30 underline-offset-2 hover:text-destructive transition-colors duration-150"
            >
              View details
            </button>
          </div>
