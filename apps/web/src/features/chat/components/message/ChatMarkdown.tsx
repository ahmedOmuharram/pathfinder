  ...
  a: (props: AnchorHTMLAttributes<HTMLAnchorElement>) => {
    ...
    const a = (
      <a
        ...
        className={
          isCitation
            ? "no-underline hover:underline decoration-muted-foreground/40 underline-offset-2"
            : "underline decoration-muted-foreground/40 underline-offset-2 hover:decoration-muted-foreground"
        }
      />
    );
