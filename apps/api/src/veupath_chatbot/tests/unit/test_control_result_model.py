...
class TestControlTargetData:
    def test_defaults(self) -> None:
        ...
        assert target.result_count is None
    ...
    def test_from_camel_case_dict(self) -> None:
        ...
        assert target.result_count == 100
...
class TestControlSetData:
    def test_defaults(self) -> None:
        ...
        assert csd.target_result_count == 0
    ...
    def test_from_camel_case_dict(self) -> None:
        ...
        assert csd.target_result_count == 200
...
class TestControlTestResult:
    ...
    def test_camel_case_alias_resolution(self) -> None:
        ...
        assert result.positive.target_result_count == 42
