...
from veupath_chatbot.ai.tools.standalone._result_models import EstimatedSizeResult
...
from veupath_chatbot.services.strategies.build import get_estimated_size_for_site
