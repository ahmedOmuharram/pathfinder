            ...
            "primaryInput": {
                ...
                "primaryInput": {
                    ...
                    "parameters": rnaseq_fc_params(
                        "https://HostDB.org/a/app/record/dataset/DS_8b52ce9c69",
                        "Transcriptome analysis of blood from Gambian children with malaria. -   - Sense",
                        "up-regulated",
                        ["UM_301", "UM_302", "UM_309", "UM_314", "UM_326"],
                        ["CM_149", "CM_207", "CM_497", "CM_503", "CM_88"],
                        RNASeqOptions(
                            fold_change="2",
            ...
            "secondaryInput": {
                ...
                "primaryInput": {
                    ...
                    "primaryInput": {
                        ...
                        "parameters": rnaseq_fc_params(
                            "https://HostDB.org/a/app/record/dataset/DS_f1c4acdfd2",
                            "Transcriptome of lung epithelial cells stimulated by hemozoin -   - Sense",
                            "up-regulated",
                            ["no hemazoin"],
                            ["200 ug_ml hemazoin"],
                            RNASeqOptions(
        ...
        step_tree={
            ...
            "primaryInput": {
                ...
                "primaryInput": {
                    ...
                    "parameters": rnaseq_fc_params(
                        "https://HostDB.org/a/app/record/dataset/DS_65d43ce7fa",
                        "T gondii infected human host cells vs control -   - Sense",
                        "up-regulated",
                        ["uninfected"],
                        ["Tgondii infected"],
                        RNASeqOptions(
                ...
                "secondaryInput": {
                    ...
                    "parameters": rnaseq_fc_params(
                        "https://HostDB.org/a/app/record/dataset/DS_d8246ca26a",
                        "Transcriptome Remodeling during Intracellular Infection -   unstranded",
                        "up-regulated",
                        ["uninf 72hpi"],
                        ["amas 72hpi"],
                        RNASeqOptions(
            ...
            "secondaryInput": {
                ...
                "primaryInput": {
                    ...
                    "primaryInput": {
                        ...
                        "parameters": rnaseq_fc_params(
                            "https://HostDB.org/a/app/record/dataset/DS_410d99350c",
                            "Host immune response against Candida auris -   - Sense",
                            "up-regulated",
                            ["RPMI_24hr"],
                            ["calb_live_24hr"],
                            RNASeqOptions(
