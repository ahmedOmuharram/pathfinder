...
from pathfinder.ai.agents import _hooks
from pathfinder.ai.agents._hooks import _GRAPH_MUTATING_TOOLS
...
from pathfinder.ai.tools.standalone.strategy_edit import delete_step
