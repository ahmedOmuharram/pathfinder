...
from pathfinder.platform.errors import ErrorCode, WDKError
...
def _handle_not_found(wdk_step_id: int, status: int) -> ToolErrorPayload:
    return tool_error(
        ErrorCode.WDK_ERROR,
...
def _handle_bad_request(wdk_step_id: int, status: int) -> ToolErrorPayload:
    return tool_error(
        ErrorCode.WDK_ERROR,
...
def _handle_auth_error(wdk_step_id: int, status: int, action: str) -> ToolErrorPayload:
    return tool_error(
        ErrorCode.WDK_ERROR,
