...
tool call from the messages so far. The scripts are the product's; this module
is the machinery that runs them.
...
RoleScript = Callable[[list[ModelMessage]], ToolCallPart]
